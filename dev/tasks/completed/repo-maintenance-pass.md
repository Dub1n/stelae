...
- **Docs drift hotspots:** README’s “Documentation Source Catalog” and “Declarative Tool Aggregations” sections still assume every downstream server ships by default, while the architecture doc now emphasizes the local-only restart path. Use this pass to align wording so the “core vs optional” stack boundaries are explicit across README/ARCHITECTURE/AGENTS.

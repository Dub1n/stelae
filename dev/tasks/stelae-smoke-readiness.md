...
- **Goals:** enforce a curated manifest (`documentation_catalog`, `workspace_fs_*`, `doc_fetch_suite`, `manage_stelae`, etc.), dedupe JSON Schema arrays before they hit Codex, and make the harness fail fast whenever Codex falls back to stale manifests.
- **What’s done:**

...
4. Optional drift gate: `make check-catalog-drift` (or the best-effort diff from `scripts/restart_stelae.sh`) fails when intended vs live catalog diverge unless `STELAE_ALLOW_LIVE_DRIFT=1`.

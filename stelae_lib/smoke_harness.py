...
def build_env_map(
    *,
    ...
    env: Dict[str, str] = {
        ...
        "STELAE_CUSTOM_TOOLS_CONFIG": str(config_home / "custom_tools.json"),
        "INTENDED_CATALOG_PATH": str(state_dir / "intended_catalog.json"),
        "LIVE_CATALOG_PATH": str(state_dir / "live_catalog.json"),
